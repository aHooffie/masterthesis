...
module lang::crds::basis::ast

import ParseTree;

public lang::crds::basis::ast::CRDSII crds_implode(Tree tree)
  = implode(#lang::crds::basis::ast::CRDSII, tree);
...
data Turn
 = opt(Action action) | req(Action action) | choice(real r, list[Action] actions);
