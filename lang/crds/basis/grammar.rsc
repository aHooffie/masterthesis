...
module lang::crds::basis::grammar
...
syntax Token
 = token: ID "=" "[" "start" VALUE "," "max" VALUE "]" ID Prop+; 	
...
keyword Reserved
 ...
 |"public" | "private" | "dealer" | "communicate" | "and" | "has" | "empty"; 
 
 /******************************************************************************
 * Functions to parse the game into a tree.
 ******************************************************************************/
